...
class MotorPositionTester : OpMode() {
    ...
    private lateinit var hanging: DcMotorEx
    ...
    override fun init() {
        ...
        hanging = hardwareMap.get(DcMotorEx::class.java, "hanging")
        ...
        hanging.mode = DcMotor.RunMode.RUN_WITHOUT_ENCODER
    }

    override fun loop() {
        g2.update()

        hanging.power = gamepad2.left_stick_y.toDouble()
        ...
        telemetry.addData("collectionArm", hanging.currentPosition)
