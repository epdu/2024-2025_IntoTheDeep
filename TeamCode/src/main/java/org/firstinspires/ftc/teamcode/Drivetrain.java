...
public class Drivetrain {
    ...
    public void init(HardwareMap ahwMap) {
        ...
        // Control HUb
        topLeftDriveMotor = hwMap.get(DcMotor.class, "LFMotor");
        bottomLeftDriveMotor = hwMap.get(DcMotor.class, "LBMotor");
        topRightDriveMotor = hwMap.get(DcMotor.class, "RFMotor");
        bottomRightDriveMotor = hwMap.get(DcMotor.class, "RBMotor");
